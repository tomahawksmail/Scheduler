...
def main():
    ...
    try:
        ...
        #                 print(unlock, file=f)
                    ...
                    # Set Permissions
                    # command = r'icacls "C:\Windows\System32\GroupPolicy\Machine" /grant Users:(OI)(CI)RW /T'
                    # client.exec_command(command)
                    # command = r'icacls "C:\Windows\System32\GroupPolicy\User" /grant Users:(OI)(CI)RW /T'
                    # client.exec_command(command)
